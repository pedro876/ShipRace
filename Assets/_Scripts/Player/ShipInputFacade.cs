...
public class ShipInputFacade : MonoBehaviour
{
    [Header("Left Axis")]
    ...
    private void Awake()
    {
        ...
        controls.ShipControls.Tilt.performed += ctx => turning = ctx.ReadValue<float>();
        controls.ShipControls.Tilt.canceled += ctx => turning = 0f;
    }
    ...
    private void Update()
    {
        ...
        leftAxis = Vector2.Lerp(leftAxis, rawLeftAxis, leftAxisLerpFactor * Time.deltaTime);
    }
